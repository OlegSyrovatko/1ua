...
<P style="font-size:11pt;  color:#006699;">
    Good day, {{$Namefr}}!
    <br />{{$Nameg}} confirms You as his friend
	<br />You can view the list of Your friends at:
    <br /><a href=https://1ua.com.ua/efriends/{{$id}}/date>https://1ua.com.ua/efriends/{{$id}}/date</a>
    <br /><br /><br />Sincerely,
