...
<P style="font-size:11pt;  color:#006699;">
    Доброго часу доби!
    <br />{{$Nameg}} додав нові фото на сторінці {{$City}}
	<br /><br />Переглянути фото Ви зможете за адресою:
<br /><a href=https://1ua.com.ua/{{$domen}}/foto>https://1ua.com.ua/{{$domen}}/foto</a>
<br />Налаштувати параметри сповіщень Ви зможете знизу сторінки:
