...
<P style="font-size:11pt;  color:#006699;">
    Good day, {{$Namefr}}!
    <br />{{$Nameg}} wants to add you as a friend
	<br />You can confirm that you are friends, or reject the request.
    <br /><a href=https://1ua.com.ua/einfriends/{{$id}}/date>https://1ua.com.ua/einfriends/{{$id}}/date</a>
    <br /><br /><br />Sincerely,
