...
class obl_future_news1 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'obl_future_news1';
     ...
     * @var string
     */
    protected $description = 'obl_future_news1';
            ...
            for ($n = 1; $n <= $count_news; $n++) {
                ...
                if ($n != 4) {
                    ...
                    if ($true_link == 0) {
                        ...
                        if ($Alladn == 0) {
                            DB::table('local_news')
                                ->insert(['obl' => $obl, 'date' => $Mdo, 'link' => $link]);
                        } else {
                            break;
                        }
                    }
